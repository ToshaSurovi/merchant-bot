...
Телефон +375(29) 1112233, электронная почта 
mylo@gmail.com"""
    )
    
    # 2️⃣ ТОЧНЫЙ ТЕКСТ + КНОПКА ПОД НИМ
    exact_text = """Для оформления заказа и получения ссылки на оплату свяжитесь по телефону 
    +375(29) 1112233 или напишите сообщение (отправьте запрос через бот).
