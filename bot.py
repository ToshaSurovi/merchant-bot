...
✉️ mylo@gmail.com"""
    ...
    exact_text = """Для оформления заказа и получения ссылки на оплату свяжитесь по телефону +375 (29) 111-22-33 или напишите сообщение (отправьте запрос через бот).
...
Доставка по г. Минску бесплатная, стоимость доставки почтовой службой - 20 р. BYN.
Срок доставки согласовывается с продавцом после оформления заказа.
Товар надлежащего качества возврату и обмену не подлежит. По вопросам согласования возврата товара и денежных средств по иным причинам обратитесь по указанным контактным данным продавца."""
